 ...
 * @author Peter Abeles
 */
public class LULinearSolver extends ALULinearSolver {

  boolean doImprove = false;

  public LULinearSolver(ALU decomp) {
    super(decomp);
  }

  public LULinearSolver(ALU decomp, boolean doImprove) {
    super(decomp);
  ...
  public void solve(Matrix b, Matrix x) {
    if (b.columnCount() != x.columnCount() && b.rowCount() != numCols
        && x.rowCount() != numCols) {
