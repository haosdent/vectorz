 ...
 * T*x = b<br>
 * <br>
 * where x and b are vectors, and T is an n by n matrix. T can either be a lower
 * or upper triangular matrix.<br>
 * </p>
 * <p>
 * These functions are designed for use inside of other algorithms. To use them
 * directly is dangerous since no sanity checks are performed.
 * </p>
 * 
 * @author Peter Abeles
 */
public class TriangularSolver {
  ...
  /**
   * <p>
   * Solves for non-singular lower triangular matrices using forward
   * substitution. <br>
   * b = L<sup>-1</sup>b<br>
   * <br>
  ...
  /**
   * <p>
   * This is a forward substitution solver for non-singular lower triangular
   * matrices. <br>
   ...
   * </p>
   * <p>
   * L is a lower triangular matrix, but it comes up with a solution as if it
   * was an upper triangular matrix that was computed by transposing L.
   * </p>
   * 
   * @param L An n by n non-singular lower triangular matrix. Not modified.
   * @param b A vector of length n. Modified.
  ...
  /**
   * <p>
   * This is a forward substitution solver for non-singular upper triangular
   * matrices. <br>
   * b = U<sup>-1</sup>b<br>
   * <br>
  ...
  public static void solveU(double U[], double[] b, int sideLength, int minRow,
      int maxRow) {
   ...
   * <p>
   * This is a forward substitution solver for non-singular upper triangular
   * matrices which are a sub-matrix inside a larger. The columns of 'b' are
   * solved for individually <br>
   * b = U<sup>-1</sup>b<br>
   * <br>
   ...
   * @param b Matrix containing the solution to the system. Overwritten with the
   *          solution.
